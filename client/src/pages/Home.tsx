...
export default function Home() {
  ...
  useEffect(() => {
    const sectionIds = ["top", "journal", "fragments", "portfolio", "about", "contact"];
    const handleScroll = () => {
    ...
    <div className="sunlit-site">
      <section className="starline-hero-stage" id="top">
        ...
        <header className="starline-hero-header">
          ...
          <nav className="starline-hero-nav" aria-label="Primary navigation">
            {navItems.map((item) => (
              <button
                key={item.id}
                className={`starline-nav-link ${activeNav === item.id ? "is-active" : ""}`}
        ...
        <div className="starline-hero-content">
          ...
          <button className="starline-hero-cta" onClick={() => scrollTo("portfolio")}>
